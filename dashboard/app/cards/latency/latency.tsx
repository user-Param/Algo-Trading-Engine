...
import type { LatencyStats } from "@/app/lib/engine-context";
...
export default function Latency() {
  ...
  // return (
  //   <div className="h-full w-full p-2 overflow-auto no-scrollbar">
  //     <div className="grid grid-cols-1 sm:grid-cols-4 gap-2 text-gray-400 no-scrollbar">
  //       {entries.map((item) => (
