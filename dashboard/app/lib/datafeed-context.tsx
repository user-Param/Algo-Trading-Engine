      ...
      try {
        ...
        ws.onopen = () => {
          ...
          const switchMsg = JSON.stringify({
            ...
            exchange: "BINANCE",
            symbols: ["BTCUSDT", "ETHUSDT", "SOLUSDT", "XRPUSDT", "ADAUSDT", "DOTUSDT", "AVAXUSDT", "DOGEUSDT", "LTCUSDT", "LINKUSDT", "UNIUSDT", "MATICUSDT", "ATOMUSDT", "ALGOUSDT", "FTMUSDT", "NEARUSDT", "VETUSDT", "ICPUSDT", "FILUSDT", "SANDUSDT"],
          });
          ws.send(switchMsg);
